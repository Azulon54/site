...
lis.eq(6).click(function(){
    ...
    $(".uploadMusic").siblings().hide();
  if(  $(".uploadMusic").css("display")=='none'){
      $(".uploadMusic").show();
      $(".optionList").css("backgroundColor","rgba(65,0,73,.8)");
      lis.eq(6).css("color","rgb(190, 98, 166)");
    lis.eq(6).siblings().css("color","rgb(255, 255, 255)");

  }else if( $(".uploadMusic").css("display")=='block'){
      $(".uploadMusic").hide();
      $(".optionList").css("backgroundColor","rgba(255,255,255)");
      lis.eq(6).css("color","rgba(255,255,255)");
